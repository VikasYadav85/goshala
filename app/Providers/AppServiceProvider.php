    ...
    private function safeSettings(): array
    {
        try {
            return [
                ...
                'phone3' => SiteSetting::get('contact_phone_3', env('TRUST_PHONE_3')),
                'email' => SiteSetting::get('contact_email', env('TRUST_EMAIL')),
                'email2' => SiteSetting::get('contact_email_2', env('TRUST_EMAIL_2')),
                'email3' => SiteSetting::get('contact_email_3', env('TRUST_EMAIL_3')),
                'whatsapp' => SiteSetting::get('contact_whatsapp', env('TRUST_WHATSAPP')),
                'whatsapp2' => SiteSetting::get('contact_whatsapp_2', env('TRUST_WHATSAPP_2')),
                'whatsapp3' => SiteSetting::get('contact_whatsapp_3', env('TRUST_WHATSAPP_3')),
            ...
            return [
                ...
                'whatsapp2' => env('TRUST_WHATSAPP_2'),
                'whatsapp3' => env('TRUST_WHATSAPP_3'),
