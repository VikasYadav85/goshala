...
class TestimonialSeeder extends Seeder
{
    ...
    {
        $items = [
            ['Rajesh Khanna', 'Donor', 'Mumbai', 'Seeing the dedication of the volunteers at Gopal Samarpan Sewa Charitable Trust changed my perspective on charity. The transparency in how they use every rupee is commendable.'],
